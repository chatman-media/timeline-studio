 ...
 * AI Director Service
 *
 * High-level service for AI Director operations.
 * All Tauri calls go through tauri/ai-director-commands.ts
 */
...
export class AIDirectorService {
  ...
  /**
   * Run comprehensive analysis on a media file
   */
  ...
  /**
   * Run quick analysis on a media file
   */
  ...
  // === Audio Analysis (via Unified System) ===
  ...
  /**
   * Check if AI Director is available
   */
