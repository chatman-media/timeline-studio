  ...
  describe("Rendering", () => {
    ...
    it("should show effects indicator when effects are present", () => {
      const clipWithEffects = {
        ...mockAudioClip,
        effects: [
          { id: "1", effectId: "reverb", enabled: true, order: 0, startTime: 0, duration: 30, parameters: {}, keyframes: {}, masks: [], blendMode: "normal" as const, opacity: 1, effectVersion: "1.0.0", createdAt: new Date(), modifiedAt: new Date() },
          { id: "2", effectId: "echo", enabled: true, order: 1, startTime: 0, duration: 30, parameters: {}, keyframes: {}, masks: [], blendMode: "normal" as const, opacity: 1, effectVersion: "1.0.0", createdAt: new Date(), modifiedAt: new Date() },
        ],
      }
