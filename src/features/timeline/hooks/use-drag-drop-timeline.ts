...
export function useDragDropTimeline(): UseDragDropTimelineReturn {
  ...
  const handleDragEnd = useCallback(
        ...
        if (dropData && dragData) {
          ...
          if (dropData.type === "track-insertion") {
            ...
            dropDetails = {
              dropType: "new-track",
              trackType,
              mediaFile: dragData.mediaFile.path,
            }
    ...
    [dragState.draggedItem, dragState.dropPosition, addSingleMediaToTimeline, addTrack, backendSync],
  )
