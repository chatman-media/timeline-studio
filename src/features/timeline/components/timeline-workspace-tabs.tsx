...
export function TimelineWorkspaceTabs({
  activeView,
  onViewChange,
}: TimelineWorkspaceTabsProps) {
    ...
    <div className="flex h-10 items-center border-b bg-background px-1">
      <div className="flex gap-1">
        ...
        <Button
          ...
          className={cn(
            "h-7 cursor-pointer gap-3",
            activeView === "analysis" && "bg-secondary",
          )}
        >
        ...
        <Button
          ...
          className={cn(
            "h-7 cursor-pointer gap-3",
            activeView === "timeline" && "bg-secondary",
          )}
        >
        ...
        <Button
          ...
          className={cn(
            "h-7 cursor-pointer gap-3",
            activeView === "audio-mixer" && "bg-secondary",
          )}
        >
