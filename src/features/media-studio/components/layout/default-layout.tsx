  ...
  if (isBrowserVisible && isOptionsVisible) {
    return (
      ...
      >
        ...
        <ResizablePanel defaultSize={50} minSize={20} maxSize={70} data-oid="zj48tin">
          <div className="h-full flex-1" data-oid="z-02lmc">
            <VideoPlayer data-oid="_g2yva5" />
          </div>
        </ResizablePanel>
        <ResizableHandle data-oid=".42p-ei" />
        <ResizablePanel defaultSize={50} minSize={20} maxSize={70} data-oid="jkuh629">
        ...
        <>
          ...
          >
            ...
            >
              ...
              <ResizablePanel defaultSize={30} minSize={20} maxSize={70} data-oid="z0i.lmn">
