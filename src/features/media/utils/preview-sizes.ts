 ...
 */
export function getOptimalTemplateSize(userPreferredSize: PreviewSize, screenCount: number): PreviewSize {
 ...
 */
export function calculateGridColumns(containerWidth: number, previewSize: PreviewSize, gap = 16): number {
