...
// ─── Module-level mocks (vi.mock is hoisted by Vitest regardless of nesting) ──
...
/**
 * No-op: vi.mock calls above are hoisted by Vitest at module load time.
 * Kept for backward compatibility with test files that call mockUIComponents().
 */
