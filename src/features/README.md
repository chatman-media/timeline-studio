...
#### [`browser`](browser/README.md) - 100%
Браузер медиафайлов с 8 табами, превью и фильтрацией.
- **Файлов**: 39 компонентов, 12 хуков, 15 сервисов
- **Покрытие тестами**: 535 тестов
- **Особенности**: Media, Music, Effects, Filters, Transitions, Subtitles, Templates, Style Templates

### 🟡 В разработке (70-89%) - 2 фичи

#### [`effects`](effects/README.md) - 95%
39+ видеоэффектов с WebGL2 рендерингом и realtime preview.
- **Файлов**: 16 компонентов, 5 хуков, 8 сервисов
- **Покрытие тестами**: 66 тестов
- **Готово**: Каталог эффектов, UI, drag & drop, realtime preview в VideoPlayer
- **Будущее**: FFmpeg export с эффектами

#### [`resources`](resources/README.md) - 72%
Управление ресурсами проекта (эффекты, фильтры, переходы).
- **Файлов**: 11 компонентов, 5 хуков
- **Покрытие тестами**: 511 тестов
- **Готово**: Type system, state management, backend sync, display
- **Будущее**: Parameter editing UI, search & filtering

### ⚠️ Опциональные / Требуют интеграции - 2 фичи

#### [`recognition`](recognition/README.md) - 100% (orphaned)
Визуализация YOLO детекции объектов.
- **Файлов**: 9 компонентов
- **Покрытие тестами**: 43 теста
- **Статус**: Готов, но НЕ интегрирован в UI
- **Примечание**: AI Director обрабатывает object/face detection напрямую через backend
