...
mod tests {
  ...
  use crate::{EventBus, ServiceContainer};
  use std::sync::Arc;
  ...
  async fn test_load_plugin_with_permissions() {
    ...
    let permissions = PluginPermissions {
      file_system: crate::plugins::permissions::FileSystemPermissions::default(),
      network: crate::plugins::permissions::NetworkPermissions::all(),
      ui_access: false,
      system_info: false,
      process_spawn: false,
    };
  ...
  async fn test_send_plugin_command_various_params() {
    ...
    let plugin_command = crate::plugins::plugin::PluginCommand {
      id: uuid::Uuid::new_v4(),
    ...
    let plugin_command2 = crate::plugins::plugin::PluginCommand {
      id: uuid::Uuid::new_v4(),
      command: "test-command".to_string(),
