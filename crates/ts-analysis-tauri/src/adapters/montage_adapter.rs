...
use crate::types::{AudioAnalysisError, AudioFloat, AudioMontageAnalysis};
...
impl MontageAudioAdapter {
  ...
  pub fn convert(
    ...
    Ok(AudioMontageAnalysis {
      ...
      tempo_analysis: montage_result
        .tempo
        .map(|t| crate::types::AudioTempoAnalysis {
      ...
      emotional_tone: Some(crate::types::AudioEmotionalTone {
