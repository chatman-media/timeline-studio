...
use crate::types::{AudioAnalysisError, AudioFFmpegAnalysis};
...
mod tests {
  use super::*;
  use crate::types::{
    AudioVolume, UnifiedDynamicsAnalysis, UnifiedFrequencyAnalysis, UnifiedQualityAnalysis,
    ...
    let ffmpeg_result = AudioFFmpegAnalysis {
      ...
      frequency_analysis: UnifiedFrequencyAnalysis {
        dominant_frequencies: vec![
          crate::types::AudioFrequency { hz: 440.0 },
          crate::types::AudioFrequency { hz: 880.0 },
        ],
        frequency_distribution: crate::types::FrequencyDistribution {
          bass_energy: 0.3,
          mid_energy: 0.5,
          treble_energy: 0.2,
          total_energy: 1.0,
        },
        spectral_centroid: crate::types::AudioFrequency { hz: 2000.0 },
        spectral_rolloff: crate::types::AudioFrequency { hz: 5000.0 },
      ...
      dynamics_analysis: UnifiedDynamicsAnalysis {
        ...
        attack_time: crate::types::AudioDuration { seconds: 0.01 },
        release_time: crate::types::AudioDuration { seconds: 0.1 },
      },
