...
use crate::services::analysis_frame_integration::{
    AnalysisFrameIntegrator, VideoAnalysisResult, ClipAnalysisResult
};
use crate::services::real_analysis_engine::AnalysisEngineConfig;
...
pub async fn test_frame_integration_on_sample(
    ...
    let test_config = AnalysisEngineConfig {
        object_model: ts_recognition::recognition::yolo_processor::YoloModel::YoloV11Nano,
        face_detection_model: ts_recognition::recognition::yolo_processor::YoloModel::YoloV11FaceNano,
        face_encoding_model: ts_recognition::recognition::facenet_processor::FaceNetModel::FaceNet128D,
