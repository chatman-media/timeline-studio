...
use crate::services::ai_director::{
...
pub fn ai_director_get_default_config(
  ...
  let config = match mode.as_str() {
    "fast" => AIDirectorConfig {
      performance_mode: crate::types::AudioPerformanceMode::Fast,
    ...
    "balanced" => AIDirectorConfig {
      performance_mode: crate::types::AudioPerformanceMode::Balanced,
      enable_audio_analysis: true,
    ...
    "quality" => AIDirectorConfig {
      performance_mode: crate::types::AudioPerformanceMode::Quality,
      enable_audio_analysis: true,
      enable_scene_detection: true,
      enable_video_analysis: true,
      enable_vision_analysis: true,
...
pub async fn ai_director_validate_config(
  ...
  if config.enable_audio_analysis {
    estimated_time += match config.performance_mode {
      crate::types::AudioPerformanceMode::Fast => 20,
      crate::types::AudioPerformanceMode::Balanced => 60,
      crate::types::AudioPerformanceMode::Quality => 180,
      crate::types::AudioPerformanceMode::Custom => 60,
    };
  }
