...
use crate::engines::SceneEngine;
use crate::services::scene_detector::SceneDetector;
use crate::types::{SceneAnalysis, TransitionInfo, UnifiedMediaFile};
use anyhow::Result;
use log::{error, info};
...
pub async fn analyze_scenes_by_path_command(
  ...
  let media = UnifiedMediaFile {
    ...
    media_type: crate::types::UnifiedMediaType::Video,
    duration: None,
    format: None,
    metadata: None,
    created_at: None,
