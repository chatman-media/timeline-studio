...
pub async fn execute_ffmpeg_simple_command(
  ...
  use crate::ffmpeg_advanced::commands_impl::execute_ffmpeg_simple;
...
pub async fn get_ffmpeg_available_codecs(
  ...
  use crate::ffmpeg_advanced::commands_impl::get_ffmpeg_codecs;
...
pub async fn get_ffmpeg_available_formats(
  ...
  use crate::ffmpeg_advanced::commands_impl::get_ffmpeg_formats;
...
pub async fn get_ffmpeg_execution_information(
  ...
  use crate::ffmpeg_advanced::commands_impl::get_ffmpeg_execution_info;
...
/// Сгенерировать превью субтитров (через ffmpeg_advanced)
pub async fn generate_subtitle_preview_ffmpeg(
  params: SubtitlePreviewAdvancedParams,
  _state: &VideoCompilerState,
) -> Result<String> {
  use crate::ffmpeg_advanced::commands_impl::generate_subtitle_preview;
...
pub async fn test_hardware_acceleration_available(
  ...
  use crate::ffmpeg_advanced::commands_impl::test_hardware_acceleration;
...
pub async fn perform_track_operations(
  ...
  // Базовая обработка операций с треком
  let result_json = serde_json::json!({
      "track_id": params.track.id,
      "name": params.track.name,
      "clip_count": params.track.clips.len()
  });
...
pub async fn get_detailed_clip_info(
  ...
  Ok(serde_json::json!({
      ...
      "start_time": params.clip.start_time,
      "end_time": params.clip.end_time,
      "duration": params.clip.end_time - params.clip.start_time,
  }))
}
...
pub async fn validate_subtitle_project(
  ...
  let is_valid = !subtitle.text.is_empty()
