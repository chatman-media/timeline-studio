...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "packages/adapters/src/node/__tests__/ai-project-editor.test.ts",
      "packages/adapters/src/node/__tests__/bot-*.test.ts",
      "packages/adapters/src/node/__tests__/publish.test.ts",
      "packages/adapters/src/node/__tests__/render-job.test.ts",
      "packages/adapters/src/node/__tests__/rust-*.test.ts",
      "packages/adapters/src/node/__tests__/telegram-*.test.ts",
      "apps/cli/src/commands/__tests__/bot-*.test.ts",
      "apps/cli/src/commands/__tests__/render-job.test.ts",
    ],
