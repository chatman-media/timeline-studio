...
pub fn build_app<R: Runtime>() -> Builder<R> {
  ...
  builder.invoke_handler(tauri::generate_handler![
    ...
    ts_render_tauri::recognition_advanced_commands::get_frame_processor_class_names,
    ts_render_tauri::recognition_advanced_commands::get_recognition_results_by_time_range,
    ts_render_tauri::recognition_advanced_commands::get_recognition_results_by_class,
    ts_render_tauri::recognition_advanced_commands::format_recognition_results_for_timeline,
    ts_render_tauri::recognition_advanced_commands::check_is_face_model,
    ts_render_tauri::recognition_advanced_commands::check_is_segmentation_model,
    // Security commands
    ...
    ts_render_tauri::gpu::auto_select_gpu,
    ts_render_tauri::gpu::benchmark_gpu,
    ts_render_tauri::misc::check_gpu_encoder_availability,
    ts_render_tauri::misc::check_hardware_acceleration,
    ts_render_tauri::gpu::check_hardware_acceleration_support,
    ts_render_tauri::gpu::get_gpu_capabilities_full,
    ts_render_tauri::misc::cache_media_metadata,
    ts_render_tauri::cache::clean_old_cache,
    ts_render_tauri::misc::cleanup_cache,
    ts_render_tauri::cache::clear_all_cache,
    ts_render_tauri::misc::clear_cache,
    ts_render_tauri::misc::clear_file_preview_cache,
    ts_render_tauri::frame_extraction::clear_frame_cache,
    ts_render_tauri::cache::clear_media_metadata_cache,
    // Prerender группа вынесена в крейт ts-render-tauri (#91, Wave 2) — пути с `prerender::`.
    ts_render_tauri::prerender::clear_prerender_cache,
    ts_render_tauri::prerender::get_prerender_cache_info,
    ts_render_tauri::prerender::prerender_segment,
    ts_render_tauri::prerender::check_prerender_status,
    ts_render_tauri::prerender::get_prerendered_segments,
    ts_render_tauri::prerender::delete_prerendered_segment,
    ts_render_tauri::prerender::optimize_prerender_cache,
    ts_render_tauri::cache::clear_preview_cache,
    ts_render_tauri::preview::clear_preview_cache_for_file,
    ts_render_tauri::preview::clear_preview_generator_cache_for_file,
    ts_render_tauri::cache::clear_project_cache,
    ts_render_tauri::preview::clear_project_previews,
    ts_render_tauri::cache::clear_render_cache,
    ts_render_tauri::cache::get_cache_stats,
    ts_render_tauri::rendering::compile_video,
    ts_render_tauri::rendering::cancel_render,
    ts_render_tauri::rendering::build_preview_command,
    ts_render_tauri::prerender::build_prerender_segment_command,
    ts_render_tauri::rendering::build_render_command_with_settings,
    ts_render_tauri::rendering::build_segment_render_command,
    ts_render_tauri::misc::create_new_project,
    ts_render_tauri::project::analyze_project,
    ts_render_tauri::project::backup_project,
    ts_render_tauri::project::check_project_media_availability,
    ts_render_tauri::preview::batch_generate_previews_service,
    // Preview advanced commands — группа вынесена в крейт ts-render-tauri (#91, Wave 2).
    ts_render_tauri::preview_advanced::create_preview_generator_with_ffmpeg,
    ts_render_tauri::preview_advanced::set_preview_generator_ffmpeg_path_advanced,
    ts_render_tauri::preview_advanced::generate_preview_batch_advanced,
    ts_render_tauri::preview_advanced::generate_single_frame_preview,
    ts_render_tauri::preview_advanced::get_preview_generator_info,
    ts_render_tauri::preview_advanced::generate_preview_with_options,
    ts_render_tauri::ffmpeg_advanced::apply_video_filter,
    ts_render_tauri::info::check_ffmpeg_available,
    ts_render_tauri::misc::check_ffmpeg_capabilities,
    ts_render_tauri::ffmpeg_advanced::check_ffmpeg_installation,
    ts_render_tauri::info::get_system_info,
    ts_render_tauri::ffmpeg_advanced::concat_videos,
    ts_render_tauri::misc::configure_cache,
    ts_render_tauri::schema::add_clip_to_track,
    ts_render_tauri::project::add_subtitles_to_project,
    ts_render_tauri::schema::create_clip,
    ts_render_tauri::metrics::create_custom_alert,
    ts_render_tauri::schema::create_effect,
    ts_render_tauri::schema::create_filter,
    ts_render_tauri::schema::create_schema_objects,
    ts_render_tauri::schema::create_style_template,
    ts_render_tauri::schema::create_subtitle_animation_new,
    ts_render_tauri::schema::create_style_template_new,
    ts_render_tauri::schema::add_effect_to_clip,
    ts_render_tauri::schema::add_filter_to_clip,
    ts_render_tauri::schema::remove_effect_from_clip,
    ts_render_tauri::schema::remove_filter_from_clip,
    ts_render_tauri::misc::get_cached_metadata,
    ts_render_tauri::misc::get_cache_memory_usage,
    ts_render_tauri::misc::get_current_gpu_info,
    ts_render_tauri::misc::get_gpu_info,
    ts_render_tauri::misc::get_recommended_gpu_encoder,
    ts_render_tauri::misc::get_render_cache_info,
    ts_render_tauri::misc::get_video_info,
    // Pipeline commands
    ts_render_tauri::pipeline::create_and_execute_pipeline,
    ts_render_tauri::pipeline::get_pipeline_info,
    ts_render_tauri::pipeline::cancel_pipeline,
    ts_render_tauri::pipeline::get_pipeline_statistics,
    ts_render_tauri::pipeline::get_pipeline_context,
    ts_render_tauri::pipeline::update_pipeline_settings,
    ts_render_tauri::pipeline::validate_pipeline_configuration,
    ts_render_tauri::pipeline::insert_pipeline_stage,
    ts_render_tauri::pipeline::remove_pipeline_stage,
    ts_render_tauri::pipeline::build_custom_pipeline,
    ts_render_tauri::pipeline::get_pipeline_execution_summary,
    ts_render_tauri::pipeline::get_pipeline_progress,
    ts_render_tauri::pipeline::cleanup_completed_pipelines,
    // Frame extraction commands
    ts_render_tauri::frame_extraction::extract_timeline_frames,
    ts_render_tauri::frame_extraction::extract_subtitle_frames,
    // Service commands
    ts_render_tauri::service::get_active_jobs,
    ts_render_tauri::service::get_render_progress,
    ts_render_tauri::service::get_render_statistics,
    ...
    ts_render_tauri::monitoring::get_service_metrics_summary,
    ts_render_tauri::monitoring::reset_service_metrics_detailed,
    ts_render_tauri::monitoring::get_all_metrics_summaries,
    ts_render_tauri::monitoring::export_metrics_prometheus_detailed,
    ts_render_tauri::monitoring::check_services_health,
    ts_render_tauri::monitoring::get_performance_metrics,
    ts_render_tauri::monitoring::reset_all_metrics,
    ts_render_tauri::monitoring::get_registry_service_metrics,
    // Video analysis commands
    ts_render_tauri::video_analysis::ffmpeg_get_metadata,
    ts_render_tauri::video_analysis::ffmpeg_detect_scenes,
    ts_render_tauri::video_analysis::ffmpeg_analyze_quality,
    ts_render_tauri::video_analysis::ffmpeg_detect_silence,
    ts_render_tauri::video_analysis::ffmpeg_analyze_motion,
    ts_render_tauri::video_analysis::ffmpeg_extract_keyframes,
    ts_render_tauri::video_analysis::ffmpeg_analyze_audio,
    ts_render_tauri::video_analysis::ffmpeg_quick_analysis,
    // Whisper commands
    ts_render_tauri::whisper_commands::whisper_transcribe_openai,
    ts_render_tauri::whisper_commands::whisper_translate_openai,
    ts_render_tauri::whisper_commands::whisper_transcribe_local,
    ts_render_tauri::whisper_commands::whisper_get_local_models,
    ts_render_tauri::whisper_commands::whisper_download_model,
    ts_render_tauri::whisper_commands::whisper_check_local_availability,
    ts_render_tauri::whisper_commands::extract_audio_for_whisper,
    // AI API Proxy команды
    ts_render_tauri::ai_api_proxy::claude_send_message,
    ts_render_tauri::ai_api_proxy::claude_send_streaming_message,
    ts_render_tauri::ai_api_proxy::claude_validate_api_key,
    ts_render_tauri::ai_api_proxy::claude_get_available_models,
    ...
    ts_render_tauri::batch::create_batch_job,
    ts_render_tauri::batch::get_batch_job_info,
    ts_render_tauri::batch::cancel_batch_job,
    ts_render_tauri::batch::list_batch_jobs,
    ts_render_tauri::batch::get_batch_processing_stats,
    ts_render_tauri::batch::update_batch_clip_result,
    ts_render_tauri::batch::cleanup_batch_jobs,
    ts_render_tauri::batch::set_batch_job_status,
    // Multimodal analysis commands
    ts_render_tauri::multimodal_commands::extract_frames_for_multimodal_analysis,
    ts_render_tauri::multimodal_commands::convert_image_to_base64,
    ts_render_tauri::multimodal_commands::extract_thumbnail_candidates,
    ts_render_tauri::multimodal_commands::create_frame_collage,
    ts_render_tauri::multimodal_commands::optimize_image_for_analysis,
    ts_render_tauri::multimodal_commands::cleanup_extracted_frames,
    // Platform optimization commands
    ts_render_tauri::platform_optimization::ffmpeg_optimize_for_platform,
    ts_render_tauri::platform_optimization::ffmpeg_generate_platform_thumbnail,
    ts_render_tauri::platform_optimization::ffmpeg_batch_optimize_platforms,
    ts_render_tauri::platform_optimization::ffmpeg_analyze_platform_compliance,
    ts_render_tauri::platform_optimization::ffmpeg_create_progressive_video,
    // Compiler settings commands — группа вынесена в крейт ts-render-tauri (#91, Wave 2).
    ts_render_tauri::compiler_settings_commands::get_compiler_settings_advanced,
    ts_render_tauri::compiler_settings_commands::update_compiler_settings_advanced,
    ...
    ts_render_tauri::workflow::create_directory,
    ts_render_tauri::workflow::create_timeline_project,
    ts_render_tauri::workflow::compile_workflow_video,
    ts_render_tauri::workflow::analyze_workflow_video_quality,
    ts_render_tauri::workflow::create_workflow_preview,
    ts_render_tauri::workflow::cleanup_workflow_temp_files,
    // FFmpeg builder commands
    ts_render_tauri::ffmpeg_builder::add_segment_inputs_to_builder,
    ts_render_tauri::ffmpeg_builder::create_ffmpeg_with_prerender_settings,
    ts_render_tauri::ffmpeg_builder::get_clip_input_index_from_builder,
    ts_render_tauri::ffmpeg_builder::get_ffmpeg_builder_info,
    // FFmpeg executor commands
    ts_render_tauri::ffmpeg_builder::execute_ffmpeg_with_progress_tracking,
    ts_render_tauri::ffmpeg_builder::execute_ffmpeg_simple_no_progress,
    ts_render_tauri::ffmpeg_builder::get_ffmpeg_executor_capabilities,
    ts_render_tauri::ffmpeg_builder::check_ffmpeg_executor_availability,
    // FFmpeg advanced commands
    ts_render_tauri::ffmpeg_advanced::generate_video_preview,
    ts_render_tauri::ffmpeg_advanced::generate_gif_preview,
    ts_render_tauri::preview::generate_waveform_preview,
    ts_render_tauri::preview::generate_waveform_data_json,
    ts_render_tauri::ffmpeg_advanced::probe_media_file,
    ts_render_tauri::ffmpeg_advanced::test_hardware_acceleration,
    ts_render_tauri::ffmpeg_advanced::generate_subtitle_preview,
    ts_render_tauri::ffmpeg_advanced::get_ffmpeg_codecs,
    ts_render_tauri::ffmpeg_advanced::get_ffmpeg_formats,
    ts_render_tauri::ffmpeg_advanced::execute_ffmpeg_with_progress,
    ts_render_tauri::ffmpeg_advanced::execute_ffmpeg_simple,
    ts_render_tauri::ffmpeg_advanced::get_ffmpeg_execution_info,
    // FFmpeg utilities commands
    ts_render_tauri::misc::execute_ffmpeg_simple_command,
    ts_render_tauri::misc::execute_ffmpeg_with_progress_advanced,
    ts_render_tauri::misc::get_ffmpeg_available_codecs,
    ts_render_tauri::misc::get_ffmpeg_available_formats,
    ts_render_tauri::misc::generate_subtitle_preview_advanced,
    ts_render_tauri::misc::get_ffmpeg_execution_information,
    ...
    ts_render_tauri::gpu::check_gpu_availability,
...
mod tests {
  ...
  fn test_critical_commands_present() {
    ...
    // let _video_ref = ts_render_tauri::compile_video;
