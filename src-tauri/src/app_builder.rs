...
pub fn build_app<R: Runtime>() -> Builder<R> {
  ...
  builder.invoke_handler(tauri::generate_handler![
    ...
    crate::video_compiler::commands::misc::check_gpu_encoder_availability,
    crate::video_compiler::commands::misc::check_hardware_acceleration,
    ...
    crate::video_compiler::commands::misc::cache_media_metadata,
    crate::video_compiler::commands::clean_old_cache,
    crate::video_compiler::commands::misc::cleanup_cache,
    crate::video_compiler::commands::cache::clear_all_cache,
    crate::video_compiler::commands::misc::clear_cache,
    crate::video_compiler::commands::misc::clear_file_preview_cache,
    crate::video_compiler::commands::frame_extraction::clear_frame_cache,
    crate::video_compiler::commands::cache::clear_media_metadata_cache,
    // Prerender группа вынесена в крейт ts-render-tauri (#91, Wave 2) — пути с `prerender::`.
    crate::video_compiler::commands::prerender::clear_prerender_cache,
    crate::video_compiler::commands::prerender::get_prerender_cache_info,
    crate::video_compiler::commands::prerender::prerender_segment,
    crate::video_compiler::commands::prerender::check_prerender_status,
    crate::video_compiler::commands::prerender::get_prerendered_segments,
    crate::video_compiler::commands::prerender::delete_prerendered_segment,
    crate::video_compiler::commands::prerender::optimize_prerender_cache,
    crate::video_compiler::commands::cache::clear_preview_cache,
    crate::video_compiler::commands::preview::clear_preview_cache_for_file,
    crate::video_compiler::commands::preview::clear_preview_generator_cache_for_file,
    crate::video_compiler::commands::cache::clear_project_cache,
    crate::video_compiler::commands::preview::clear_project_previews,
    crate::video_compiler::commands::cache::clear_render_cache,
    crate::video_compiler::commands::get_cache_stats,
    crate::video_compiler::commands::rendering::compile_video,
    crate::video_compiler::commands::rendering::cancel_render,
    crate::video_compiler::commands::rendering::build_preview_command,
    crate::video_compiler::commands::prerender::build_prerender_segment_command,
    crate::video_compiler::commands::rendering::build_render_command_with_settings,
    crate::video_compiler::commands::rendering::build_segment_render_command,
    crate::video_compiler::commands::misc::create_new_project,
    crate::video_compiler::commands::project::analyze_project,
    crate::video_compiler::commands::project::backup_project,
    crate::video_compiler::commands::project::check_project_media_availability,
    crate::video_compiler::commands::preview::batch_generate_previews_service,
    // Preview advanced commands — группа вынесена в крейт ts-render-tauri (#91, Wave 2).
    crate::video_compiler::commands::preview_advanced::create_preview_generator_with_ffmpeg,
    crate::video_compiler::commands::preview_advanced::set_preview_generator_ffmpeg_path_advanced,
    crate::video_compiler::commands::preview_advanced::generate_preview_batch_advanced,
    crate::video_compiler::commands::preview_advanced::generate_single_frame_preview,
    crate::video_compiler::commands::preview_advanced::get_preview_generator_info,
    crate::video_compiler::commands::preview_advanced::generate_preview_with_options,
    crate::video_compiler::commands::ffmpeg_advanced::apply_video_filter,
    crate::video_compiler::commands::info::check_ffmpeg_available,
    crate::video_compiler::commands::misc::check_ffmpeg_capabilities,
    crate::video_compiler::commands::ffmpeg_advanced::check_ffmpeg_installation,
    crate::video_compiler::commands::info::get_system_info,
    crate::video_compiler::commands::ffmpeg_advanced::concat_videos,
    crate::video_compiler::commands::misc::configure_cache,
    crate::video_compiler::commands::schema::add_clip_to_track,
    crate::video_compiler::commands::project::add_subtitles_to_project,
    crate::video_compiler::commands::schema::create_clip,
    crate::video_compiler::commands::metrics::create_custom_alert,
    crate::video_compiler::commands::schema::create_effect,
    crate::video_compiler::commands::schema::create_filter,
    crate::video_compiler::commands::schema::create_schema_objects,
    crate::video_compiler::commands::schema::create_style_template,
    crate::video_compiler::commands::schema::create_subtitle_animation_new,
    crate::video_compiler::commands::schema::create_style_template_new,
    crate::video_compiler::commands::schema::add_effect_to_clip,
    crate::video_compiler::commands::schema::add_filter_to_clip,
    crate::video_compiler::commands::schema::remove_effect_from_clip,
    crate::video_compiler::commands::schema::remove_filter_from_clip,
    crate::video_compiler::commands::misc::get_cached_metadata,
    crate::video_compiler::commands::misc::get_cache_memory_usage,
    crate::video_compiler::commands::misc::get_current_gpu_info,
    crate::video_compiler::commands::misc::get_gpu_info,
    crate::video_compiler::commands::misc::get_recommended_gpu_encoder,
    crate::video_compiler::commands::misc::get_render_cache_info,
    crate::video_compiler::commands::misc::get_video_info,
    // Pipeline commands
    crate::video_compiler::commands::pipeline::create_and_execute_pipeline,
    crate::video_compiler::commands::pipeline::get_pipeline_info,
    crate::video_compiler::commands::pipeline::cancel_pipeline,
    crate::video_compiler::commands::pipeline::get_pipeline_statistics,
    crate::video_compiler::commands::pipeline::get_pipeline_context,
    crate::video_compiler::commands::pipeline::update_pipeline_settings,
    crate::video_compiler::commands::pipeline::validate_pipeline_configuration,
    crate::video_compiler::commands::pipeline::insert_pipeline_stage,
    crate::video_compiler::commands::pipeline::remove_pipeline_stage,
    crate::video_compiler::commands::pipeline::build_custom_pipeline,
    crate::video_compiler::commands::pipeline::get_pipeline_execution_summary,
    crate::video_compiler::commands::pipeline::get_pipeline_progress,
    crate::video_compiler::commands::pipeline::cleanup_completed_pipelines,
    // Frame extraction commands
    crate::video_compiler::commands::frame_extraction::extract_timeline_frames,
    crate::video_compiler::commands::frame_extraction::extract_subtitle_frames,
    // Service commands
    crate::video_compiler::commands::service::get_active_jobs,
    crate::video_compiler::commands::service::get_render_progress,
    crate::video_compiler::commands::service::get_render_statistics,
    // Monitoring commands — группа вынесена в крейт ts-render-tauri (#91, Wave 2),
    // пути квалифицированы подмодулем `monitoring::` (для tauri::generate_handler!).
    crate::video_compiler::commands::monitoring::get_service_metrics_summary,
    crate::video_compiler::commands::monitoring::reset_service_metrics_detailed,
    crate::video_compiler::commands::monitoring::get_all_metrics_summaries,
    crate::video_compiler::commands::monitoring::export_metrics_prometheus_detailed,
    crate::video_compiler::commands::monitoring::check_services_health,
    crate::video_compiler::commands::monitoring::get_performance_metrics,
    crate::video_compiler::commands::monitoring::reset_all_metrics,
    crate::video_compiler::commands::monitoring::get_registry_service_metrics,
    // Video analysis commands
    crate::video_compiler::commands::video_analysis::ffmpeg_get_metadata,
    crate::video_compiler::commands::video_analysis::ffmpeg_detect_scenes,
    crate::video_compiler::commands::video_analysis::ffmpeg_analyze_quality,
    crate::video_compiler::commands::video_analysis::ffmpeg_detect_silence,
    crate::video_compiler::commands::video_analysis::ffmpeg_analyze_motion,
    crate::video_compiler::commands::video_analysis::ffmpeg_extract_keyframes,
    crate::video_compiler::commands::video_analysis::ffmpeg_analyze_audio,
    crate::video_compiler::commands::video_analysis::ffmpeg_quick_analysis,
    // Whisper commands
    crate::video_compiler::commands::whisper_commands::whisper_transcribe_openai,
    crate::video_compiler::commands::whisper_commands::whisper_translate_openai,
    crate::video_compiler::commands::whisper_commands::whisper_transcribe_local,
    crate::video_compiler::commands::whisper_commands::whisper_get_local_models,
    crate::video_compiler::commands::whisper_commands::whisper_download_model,
    crate::video_compiler::commands::whisper_commands::whisper_check_local_availability,
    crate::video_compiler::commands::whisper_commands::extract_audio_for_whisper,
    ...
    crate::video_compiler::commands::batch::create_batch_job,
    crate::video_compiler::commands::batch::get_batch_job_info,
    crate::video_compiler::commands::batch::cancel_batch_job,
    crate::video_compiler::commands::batch::list_batch_jobs,
    crate::video_compiler::commands::batch::get_batch_processing_stats,
    crate::video_compiler::commands::batch::update_batch_clip_result,
    crate::video_compiler::commands::batch::cleanup_batch_jobs,
    crate::video_compiler::commands::batch::set_batch_job_status,
    // Multimodal analysis commands
    crate::video_compiler::commands::multimodal_commands::extract_frames_for_multimodal_analysis,
    crate::video_compiler::commands::multimodal_commands::convert_image_to_base64,
    crate::video_compiler::commands::multimodal_commands::extract_thumbnail_candidates,
    crate::video_compiler::commands::multimodal_commands::create_frame_collage,
    crate::video_compiler::commands::multimodal_commands::optimize_image_for_analysis,
    crate::video_compiler::commands::multimodal_commands::cleanup_extracted_frames,
    ...
    // Compiler settings commands — группа вынесена в крейт ts-render-tauri (#91, Wave 2).
    crate::video_compiler::commands::compiler_settings_commands::get_compiler_settings_advanced,
    crate::video_compiler::commands::compiler_settings_commands::update_compiler_settings_advanced,
    ...
    crate::video_compiler::commands::ffmpeg_builder::add_segment_inputs_to_builder,
    crate::video_compiler::commands::ffmpeg_builder::create_ffmpeg_with_prerender_settings,
    crate::video_compiler::commands::ffmpeg_builder::get_clip_input_index_from_builder,
    crate::video_compiler::commands::ffmpeg_builder::get_ffmpeg_builder_info,
    // FFmpeg executor commands
    crate::video_compiler::commands::ffmpeg_builder::execute_ffmpeg_with_progress_tracking,
    crate::video_compiler::commands::ffmpeg_builder::execute_ffmpeg_simple_no_progress,
    crate::video_compiler::commands::ffmpeg_builder::get_ffmpeg_executor_capabilities,
    crate::video_compiler::commands::ffmpeg_builder::check_ffmpeg_executor_availability,
    // FFmpeg advanced commands
    crate::video_compiler::commands::ffmpeg_advanced::generate_video_preview,
    crate::video_compiler::commands::ffmpeg_advanced::generate_gif_preview,
    crate::video_compiler::commands::preview::generate_waveform_preview,
    crate::video_compiler::commands::preview::generate_waveform_data_json,
    crate::video_compiler::commands::ffmpeg_advanced::probe_media_file,
    crate::video_compiler::commands::ffmpeg_advanced::test_hardware_acceleration,
    crate::video_compiler::commands::ffmpeg_advanced::generate_subtitle_preview,
    crate::video_compiler::commands::ffmpeg_advanced::get_ffmpeg_codecs,
    crate::video_compiler::commands::ffmpeg_advanced::get_ffmpeg_formats,
    crate::video_compiler::commands::ffmpeg_advanced::execute_ffmpeg_with_progress,
    crate::video_compiler::commands::ffmpeg_advanced::execute_ffmpeg_simple,
    crate::video_compiler::commands::ffmpeg_advanced::get_ffmpeg_execution_info,
    // FFmpeg utilities commands
    crate::video_compiler::commands::misc::execute_ffmpeg_simple_command,
    crate::video_compiler::commands::misc::execute_ffmpeg_with_progress_advanced,
    crate::video_compiler::commands::misc::get_ffmpeg_available_codecs,
    crate::video_compiler::commands::misc::get_ffmpeg_available_formats,
    crate::video_compiler::commands::misc::generate_subtitle_preview_advanced,
    crate::video_compiler::commands::misc::get_ffmpeg_execution_information,
