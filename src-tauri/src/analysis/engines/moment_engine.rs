...
impl MomentEngine {
    ...
    fn score_emotional_importance(&self, scene: &SceneAnalysis) -> f64 {
        ...
        let base_score = match scene.scene_type {
    ...
    fn create_moment(
        ...
        let scoring = MomentScoring {
            ...
            person_prominence: if scene.persons.is_empty() {
                0.3
            } else {
                0.7
            },
    ...
    fn determine_moment_type(&self, scene: &SceneAnalysis, _timestamp: f64) -> MomentType {
        ...
        match scene.scene_type {
            ...
            crate::analysis::types::unified_types::SceneType::Dialog => {
                MomentType::DialogueHighlight
            }
            crate::analysis::types::unified_types::SceneType::Landscape => {
                MomentType::VisualStunning
            }
            crate::analysis::types::unified_types::SceneType::Closeup => {
                MomentType::EmotionalPeak
            }
            crate::analysis::types::unified_types::SceneType::Establishing => {
                MomentType::VisualStunning
            }
    ...
    fn calculate_moment_duration(&self, scene: &SceneAnalysis, timestamp: f64, importance: f64) -> f64 {
