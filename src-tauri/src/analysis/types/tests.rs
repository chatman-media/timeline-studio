...
mod tests {
    ...
    use crate::analysis::types::{AudioFloat, AudioDuration, AudioTimestamp, AudioVolume, AudioFrequency};
    use chrono;
    ...
    fn test_audio_time_range() {
        ...
        let range = AudioTimeRange { start, end };
        
        assert_eq!(range.start.seconds, 1.0);
        assert_eq!(range.end.seconds, 3.5);
        
        // Duration calculation
        let duration = range.end.seconds - range.start.seconds;
    ...
    fn test_unified_audio_analysis_result_structure() {
        ...
        let basic_metrics = AudioBasicMetrics {
            ...
            file_size_bytes: Some(10485760), // 10MB
    ...
    fn test_audio_transcription_analysis_unified_fields() {
        ...
        assert_eq!(analysis.transcription_text, Some("Test segment".to_string()));
    ...
    fn test_serialization_deserialization() {
        ...
        let deserialized: AudioVolume = serde_json::from_str(&serialized).expect("Failed to deserialize");
        ...
        let deserialized: AudioDuration = serde_json::from_str(&serialized).expect("Failed to deserialize");
