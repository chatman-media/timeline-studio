...
impl WhisperAudioAdapter {
    ...
    pub fn convert(
        ...
        let total_duration = whisper_result.duration.map(|d| AudioDuration { seconds: d });
        ...
        if let Some(words) = whisper_words {
            return words
                ...
                .map(|word| TranscriptionWord {
                    ...
                    start_time: AudioTimestamp { seconds: word.start },
            ...
            for segment in segs {
                ...
                for (i, word) in segment_words.iter().enumerate() {
                    ...
                    words.push(TranscriptionWord {
                        word: word.to_string(),
                        start_time: AudioTimestamp { seconds: word_start },
