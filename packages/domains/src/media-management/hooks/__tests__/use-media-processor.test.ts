...
import { type DiscoveredFile, useMediaProcessor } from "@timeline-studio/domains/media-management/hooks/use-media-processor"
...
vi.mock("@timeline-studio/domains/video-editing/services/compiler/metadata-cache-service", () => ({
...
import { mediaProcessorService } from "@timeline-studio/domains/media-management/services/media-processor-service"
...
describe("useMediaProcessor", () => {
  ...
  beforeEach(async () => {
    ...
    const metadataCache = await import("@timeline-studio/domains/video-editing/services/compiler/metadata-cache-service")
