...
import { useMediaRestoration } from "@timeline-studio/domains/media-management/hooks/use-media-restoration"

// Мокаем MediaRestorationService
vi.mock("@timeline-studio/domains/media-management/services/media-restoration-service", () => ({
...
const { restoreProjectMedia, generateRestorationReport } = await import(
  "@timeline-studio/domains/media-management/services/media-restoration-service"
)
