...
import type { MediaPreviewData, ThumbnailData } from "@timeline-studio/domains/media-management"
import { useMediaPreview } from "@timeline-studio/domains/media-management/hooks/use-media-preview"
import { indexedDBCacheService } from "@timeline-studio/domains/media-management/services/indexeddb-cache-service"
import { mediaPreviewService } from "@timeline-studio/domains/media-management/services/media-preview-service"

// Mock mediaPreviewService
vi.mock("@timeline-studio/domains/media-management/services/media-preview-service", () => ({
  mediaPreviewService: {
...
vi.mock("@timeline-studio/domains/media-management/services/indexeddb-cache-service", () => ({
