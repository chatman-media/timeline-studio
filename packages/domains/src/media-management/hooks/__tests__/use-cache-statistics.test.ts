...
import { useCacheStatistics } from "@timeline-studio/domains/media-management/hooks/use-cache-statistics"
import type { CacheStatistics } from "@timeline-studio/domains/media-management/services/indexeddb-cache-service"
...
describe("useCacheStatistics", () => {
  ...
  it("should load statistics on mount", async () => {
    ...
    const { indexedDBCacheService } = await import("@timeline-studio/domains/media-management/services/indexeddb-cache-service")
