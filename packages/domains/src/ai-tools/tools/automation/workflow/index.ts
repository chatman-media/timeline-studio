...
import { WorkflowAutomationService, WorkflowParams, WorkflowType } from "@timeline-studio/domains/ai-services"
      ...
      switch (input.operation) {
        ...
        case "execute_workflow":
          ...
          result = {
            ...
            executionResult: {
              ...executionResult,
              workflowId: executionResult.workflowId || `exec_${Date.now()}`,
              workflowType: input.workflowType,
              status: "completed",
