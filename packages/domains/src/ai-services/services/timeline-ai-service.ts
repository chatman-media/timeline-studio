...
// REMOVED: import { null as any /* getAIContainer from deleted ai-core */ } from "@timeline-studio/domains/ai-core" // ai-core module deleted - use backend AI proxy instead
...
import { multimodalTools as multimodalAnalysisTools } from "@timeline-studio/domains/ai-tools/tools/analysis/multimodal"
import { personIdentificationTools } from "@timeline-studio/domains/ai-tools/tools/analysis/person-identification"
import { videoAnalysisTools } from "@timeline-studio/domains/ai-tools/tools/analysis/video-analysis"
import { whisperTools } from "@timeline-studio/domains/ai-tools/tools/analysis/whisper"
import { batchProcessingTools } from "@timeline-studio/domains/ai-tools/tools/automation/batch-processing"
import { performanceTools as platformOptimizationTools } from "@timeline-studio/domains/ai-tools/tools/automation/performance"
import { subtitleTools } from "@timeline-studio/domains/ai-tools/tools/automation/subtitles"
import { workflowTools as workflowAutomationTools } from "@timeline-studio/domains/ai-tools/tools/automation/workflow"
import { browserTools, executeBrowserTool } from "@timeline-studio/domains/ai-tools/tools/core/browser"
import { effectsFiltersTools, executeEffectsFiltersTool } from "@timeline-studio/domains/ai-tools/tools/core/effects-filters-tools"
import { executePlayerTool, playerTools } from "@timeline-studio/domains/ai-tools/tools/core/player"
import { executeResourceTool, resourceTools } from "@timeline-studio/domains/ai-tools/tools/core/resources"
import { executeTimelineTool, timelineTools } from "@timeline-studio/domains/ai-tools/tools/core/timeline"
import { exportTools as exportManagementTools } from "@timeline-studio/domains/ai-tools/tools/integration/export"
import type { MediaFile } from "@timeline-studio/domains/media-management"
import type { ResourcesContextType } from "@timeline-studio/domains/shared/types/resources"
