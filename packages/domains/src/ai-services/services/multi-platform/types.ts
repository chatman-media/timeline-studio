...
import type { AdaptedContent, Platform } from "@timeline-studio/domains/shared/types/ai-tools/platform-adaptation"
import type { MediaFile as SharedMediaFile } from "@timeline-studio/domains/shared/types/media/media-file"
