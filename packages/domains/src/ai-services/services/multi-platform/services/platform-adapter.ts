...
// REMOVED: import { UnifiedAIService } from "@timeline-studio/domains/ai-core" // ai-core module deleted - use backend AI proxy instead
import { UnifiedContentAnalysis } from "@timeline-studio/domains/ai-services/types/unified-analysis"
import {
  AdaptedContent,
  AspectRatio,
  AudioSpecs,
  ...
  PlatformResolution,
  VideoSpecs,
} from "@timeline-studio/domains/shared/types/ai-tools/platform-adaptation"
import {
  AdaptationStrategy,
