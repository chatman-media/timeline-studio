...
// REMOVED: import { EnhancedUnifiedAIService } from "@timeline-studio/domains/ai-core/services" // ai-core module deleted - use backend AI proxy instead
import type { AdaptedContent } from "@timeline-studio/domains/shared/types/ai-tools/platform-adaptation"
