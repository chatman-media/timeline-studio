...
// react-resizable-panels v4 renamed: direction → orientation, autoSaveId removed
type ResizablePanelGroupProps = Omit<React.ComponentProps<typeof ResizablePrimitive.Group>, "orientation"> & {
  direction?: "horizontal" | "vertical"
  orientation?: "horizontal" | "vertical"
  autoSaveId?: string // no-op in v4, kept for API compat
}

function ResizablePanelGroup({ className, direction, orientation, autoSaveId, ...props }: ResizablePanelGroupProps) {
