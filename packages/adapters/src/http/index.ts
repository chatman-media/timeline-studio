 ...
 * @example
 * ```typescript
 * import { initHttpApp } from "@timeline-studio/adapters/http"
 *
...
import { MockLanguageService, MockPlatformService, MockStorageService, MockUserSettingsService } from "@timeline-studio/adapters/mock"
