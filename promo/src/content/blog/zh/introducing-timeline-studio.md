...
我们很高兴地宣布Timeline Studio，这是一款下一代视频编辑器，将AI的力量与专业编辑工具无缝结合在一个应用程序中。

## 为什么选择Timeline Studio？
...
### ⚡ 性能
- 使用NVENC、QuickSync、VideoToolbox的硬件加速
- GPU处理的实时预览
- 高效内存管理
...
Timeline Studio适用于Windows、macOS和Linux。下载最新版本，今天就开始创建精彩内容！

[下载Timeline Studio →](#download)
