...
export const Footer: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className="z-10 transition-all duration-300 grid w-full grid-cols-12 gap-2 px-4 sm:px-6 md:gap-4 md:px-10 lg:px-12 xl:px-20 xl:gap-6 max-w-[1920px] mx-auto"
        data-oid="61b8nxa"
      >
        <div
          className="col-span-12 mb-8 mt-10 md:mb-0 md:mt-14"
          data-oid="3469r6n"
        >
          <div
          ...
          >
            {/* Logo on the left */}
            <div className="shrink-0 md:w-1/4" data-oid="lo.ndeq">
              <Link to="/" className="inline-block" data-oid="tl4x35s">
                <Logo size="small" showText={false} data-oid="t.roq13" />
              </Link>
            </div>

            {/* Three columns on the right */}
            <div
              className="mt-10 grid grid-cols-1 gap-8 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 md:mb-[120px] md:mt-0 lg:flex lg:flex-row lg:gap-[60px] xl:gap-80"
              data-oid="na6dei7"
            >
              {/* Product Column */}
              <div data-oid="m56gujc">
                <h3
                ...
                <ul className="space-y-3" data-oid="vmi_tqv">
                  <li data-oid="s1v_:lb">
                    <Link
                      to="/about"
              ...
              <div data-oid="qmcen1f">
                ...
                <ul className="space-y-3" data-oid="w-tk8_l">
                  <li data-oid="-x9xgc:">
                    <Link
                      to="/docs"
                      className="text-sm text-gray-300 hover:text-gray-100 transition-colors"
              ...
              <div data-oid="53zfh6g">
                ...
                <ul className="space-y-3" data-oid="nyv8v9t">
                  <li data-oid=".gph:ps">
                    <Link
                      to="/investors"
              ...
              <div data-oid=":xd045_">
                <h3
                  className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-6 whitespace-nowrap"
                  data-oid="3j1ykci"
                >
                  {t("footer.social.title")}
                </h3>
                <div className="flex flex-wrap gap-4" data-oid="b8p8xw9">
                  <a
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-800 py-6" data-oid="vsy_i4m">
        <div
          className="px-4 sm:px-6 md:px-10 lg:px-12 xl:px-20 max-w-[1920px] mx-auto"
          data-oid="9ao5au7"
        >
          <div
            className="flex flex-col items-center space-y-4 md:flex-row md:justify-between md:space-y-0"
            data-oid="9pt-cyb"
          >
            <div
