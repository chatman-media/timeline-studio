...
export const SearchDemo: React.FC<SearchDemoProps> = ({ className = "" }) => {
  return (
    <div className={`relative ${className}`} data-oid="fc_uwyc">
      ...
      >
        ...
        <div
          className="absolute inset-0 rounded-2xl bg-linear-to-r from-purple-500 via-pink-500 to-orange-500 p-[2px]"
          data-oid="a6r7ezz"
        >
          <div
            className="h-full w-full rounded-2xl bg-[#12192C]"
            data-oid="737ukhz"
          />
        </div>
        ...
        <div className="relative" data-oid="m:-5g_2">
          ...
          <div
            className="md:hidden w-full aspect-video bg-linear-to-br from-purple-900/20 to-pink-900/20 rounded-2xl flex items-center justify-center"
            data-oid="y3guqj5"
          >
            <div className="text-center text-white/60" data-oid="eykevib">
              <Clapperboard
                className="w-12 h-12 mx-auto mb-2"
                data-oid="rdswc:m"
              />
              <p className="text-sm" data-oid="5p1drpf">
