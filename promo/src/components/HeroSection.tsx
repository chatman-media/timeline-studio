    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <a
            href="https://github.com/chatman-media/timeline-studio/blob/main/LICENSE"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-full border border-white/10 transition-all"
          >
            <span className="text-sm text-gray-300 font-medium">MIT License</span>
          </a>
        </motion.div>
        ...
        >
          ...
          <br />
          <span className="text-gradient">with 100+ AI Tools</span>
        </motion.h1>
        ...
        >
          All features <span className="text-green-400 font-semibold">FREE forever</span>. Local AI processing.
          <br className="hidden md:block" />
          No subscriptions. Your data stays private.
        </motion.p>
