...
export function Navigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? "py-0" : "py-3"}`}>
      <div className={`transition-all duration-500 ${isScrolled ? "px-2 md:px-2 pt-3" : "px-2 md:px-2 lg:px-2"}`}>
        <div
          className={`flex items-center justify-between transition-all duration-500 outline-none border border-transparent px-3 md:px-5 py-3 ${
