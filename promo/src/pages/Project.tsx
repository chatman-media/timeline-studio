                  ...
                  {loading ? (
                    ...
                    <div className="prose-invert prose-lg max-w-none">
                      <ReactMarkdown
                        ...
                        components={{
                          h1: ({ children }) => <h1 className="text-4xl md:text-5xl font-light mb-8 text-gradient">{children}</h1>,
                          ...
                          a: ({ href, children }) => <a href={href} className="text-blue-400 hover:text-blue-300 transition-colors underline" target="_blank" rel="noopener noreferrer">{children}</a>,
                        }}
                      >
                        {markdownContent}
                      </ReactMarkdown>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: language === 'ru' ? 'Полная техническая документация' : 'Complete technical documentation',
                    href: '/docs',
                    icon: '📚'
                  },
                  {
