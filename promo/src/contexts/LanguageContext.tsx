...
const translations = {
  en: {
    ...
    "about.localModels.feature2": "Local scene analysis models (YOLO, Moondream)",
  ...
  ru: {
    ...
    "about.localModels.feature2": "Локальные модели анализа сцен (YOLO, Moondream)",
  ...
  zh: {
    ...
    "about.localModels.feature2": "本地场景分析模型 (YOLO, Moondream)",
