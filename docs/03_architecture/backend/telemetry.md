...
> **⚠️ ВАЖНО:** Для логирования в Timeline Studio используйте **TauriLogger**, а не console.*
> См. [TauriLogger Руководство](./telemetry-tauri-logger.md) для полной документации.
