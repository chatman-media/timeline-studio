...
- [x] Добавить deprecation notices в старые tauri/ файлы
- [x] Обновить документацию (src/core/README.md, src/adapters/README.md)
- [x] Финальный тест (11,563 тестов проходят)
- [x] Перенести в completed/
